        ...
        return (
            <section className="image-gallery gallery-licho">
                ...
                <div className="gallery-descriptions">
                    ...
                    {this.props.language === 'pl' ? <p className="description">W pewnym starym, niesamowitym domu na uboczu, za wysokim ogrodzeniem, mieszka chłopiec imieniem Bożek, zwany też Niebożątkiem, który nigdy nie jest sam. Bo oprócz starej skrzyni ze skarbami i najfajniejszej mamy pod słońcem ma też najprawdziwszego anioła stróża... a pod jego łóżkiem mieszka potwór, który ciągle podkrada mu kapcie.</p> : <p className="description">In a certain old, amazing house off the beaten track, behind a high fence, lives a boy named Bożek, also known as the Poor Thing who is never alone. Because in addition to the old treasure chest and the coolest mother under the sun, he also has a real guardian angel... and under his bed lives a monster who constantly steals his slippers.</p>}
                    {this.props.language === 'pl' ? <p className="description">"Małe Licho i tajemnica Niebożątka" to trochę zabawna, a trochę straszna historia o tym, że bycie innym wcale nie jest takie złe, jak może się z początku wydawać, lecz najważniejsze jest zawsze bycie sobą.</p> : <p className="description">"Little Devil and the Mystery of Poor Thing" is a bit funny and a bit scary story about being different is not as bad as it may seem at first, but the most important thing is always being yourself.</p>}
