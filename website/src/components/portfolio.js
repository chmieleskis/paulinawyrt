    ...
    render() {
        return (
            <section className='portfolio'>
                <Link to={'/portfolio/gallery-1'} className="miniature gallery-food"><div className="mini-shade">{this.props.language === "pl" ? <p>Madzia</p> : <p>Na Frasunek Blog</p>}</div></Link>
                <Link to={'/portfolio/gallery-2'} className="miniature"><div className="mini-shade">{this.props.language === "pl" ? <p>O prawie rozmowy z użyciem głowy</p> : <p>conversations about law</p>}</div></Link>
                <Link to={'/portfolio/gallery-3'} className="miniature"><div className="mini-shade">{this.props.language === "pl" ? <p>jest</p> : <p>absolutnie</p>}</div></Link>
                <Link to={'/portfolio/gallery-4'} className="miniature"><div className="mini-shade">{this.props.language === "pl" ? <p>super</p> : <p>najfajniejsza</p>}</div></Link>
