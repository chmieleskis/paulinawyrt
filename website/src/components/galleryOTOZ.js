        ...
        return (
            <section className="image-gallery">
                ...
                <div className="gallery-descriptions">
                    ...
                    {this.props.language === 'pl' ? <p className='category'>Kategoria: <Link className='category-link' onClick={this.props.posters} to={'/'}>plakaty, </Link><Link className='category-link' onClick={this.props.films} to={'/'}>filmy, </Link><Link className='category-link' onClick={this.props.other} to={'/'}>inne</Link></p> : <p className='category'>Category: <Link className='category-link' onClick={this.props.posters} to={'/'}>posters, </Link><Link className='category-link' onClick={this.props.films} to={'/'}> animated films, </Link><Link className='category-link' onClick={this.props.other} to={'/'}>other</Link></p>}
