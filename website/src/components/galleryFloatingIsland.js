        ...
        return (
            <section className="image-gallery">
                ...
                <div className="gallery-descriptions">
                    ...
                    {this.props.language === 'pl' ? <p className='category'>Kategoria: <Link className='category-link' onClick={this.props.posters} to={'/'}>plakat, </Link><Link className='category-link' onClick={this.props.films} to={'/'}>film, </Link><Link className='category-link' onClick={this.props.other} to={'/'}>inne</Link></p> : <p className='category'>Category: <Link className='category-link' onClick={this.props.posters} to={'/'}>posters, </Link><Link className='category-link' onClick={this.props.films} to={'/'}> animated films</Link>, <Link className='category-link' onClick={this.props.other} to={'/'}>other</Link></p>}
                    {this.props.language === 'pl' ? <p className="illustrations">Muzyka: Audience Killers<br/>Realizacja filmu i opracowanie graficzne: Paulina Wyrt<br/>Liternictwo: Beata Kurek</p> : <p className="illustrations">Music by: Audience Killers<br/>Realized and graphic design by Paulina Wyrt<br/>Lettering: Beata Kurek</p>}
