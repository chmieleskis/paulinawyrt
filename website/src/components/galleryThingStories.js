        ...
        return (
            <section className="image-gallery gallery-licho">
                ...
                <div className="gallery-descriptions">
                    ...
                    {this.props.language === 'pl' ? <p className="description">"Opowieści przedmiotów" to zestaw baśni zainspirowanych niezwykłymi zbiorami Muzeum Narodowego w Krakowie. Po baśnie te powinien sięgnąć każdy, kto chciałby wiedzieć,skąd się wzięły muszki na twarzy, dlaczego nie należy zbyt intensywnie machać wachlarzem i dlaczego nie warto szukać przyjaciela po drugiej stronie lustra.</p> : <p className="description">"Stories of Objects" is a set of fairy tales inspired by the extraordinary collections of the National Museum in Krakow. Those fairy tales should be reached by anyone who wants to know where the bow ties came from, why you shouldn't wave the fan too hard, and why you shouldn't look for a friend on the other side of the mirror.</p>}
                    {this.props.language === 'pl' ? <p className="description">Wydanie zawiera okładkę i czterdzieści ilustracji.</p> : <p className="description">Edition includes a colored cover and forty illustrations.</p>}
                </div>
            </section>
        )
    }
